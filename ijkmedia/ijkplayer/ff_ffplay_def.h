...
#define DEFAULT_NEXT_HIGH_WATER_MARK_IN_MS      (1 * 1000)//dhlu for decrease Buffering times when playing.
#define DEFAULT_LAST_HIGH_WATER_MARK_IN_MS      (5 * 1000)//dhlu for decrease Buffering times when playing.
